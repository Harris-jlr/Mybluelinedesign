<template>
  <Popover class="relative bg-white">
    <div class="flex justify-between items-center px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
      <div>
        <a href="https://tailwindui.com/" class="flex" target="_blank">
      ...
      <div class="hidden md:flex-1 md:flex md:items-center md:justify-between">
        <PopoverGroup as="nav" class="flex space-x-10">
          ...
          <a href="/documentation" class="text-base font-medium text-gray-500 hover:text-gray-900"> Documentation </a>
          <a href="/contact" class="text-base font-medium text-gray-500 hover:text-gray-900"> Contact </a>
          <a href="/schedule" class="text-base font-medium text-gray-500 hover:text-gray-900"> Schedule </a>
          <a href="/container" class="text-base font-medium text-gray-500 hover:text-gray-900"> Container </a>
