...
const navigation = [
  { name: 'Anycharts', href: '#', icon: HomeIcon, current: true },
  { name: 'Charts.js', href: '#', icon: UsersIcon, current: false },
  { name: 'Highcharts', href: '#', icon: FolderIcon, current: false },
  { name: 'AmCharts', href: '#', icon: CalendarIcon, current: false },
  { name: 'Fushioncharts', href: '#', icon: InboxIcon, current: false },
  { name: 'd3.js', href: '#', icon: ChartBarIcon, current: false },
]
